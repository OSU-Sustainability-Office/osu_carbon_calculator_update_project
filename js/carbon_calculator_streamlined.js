...
//TODO: What is this 1.09? Let's label it.
...
/*******************************************************************************
                                  CONSUMPTION
*******************************************************************************/
//TODO: What does 7.46 and 10.9 represent? Let's label it.
...
function consumption_clothing_conv() {
  ...
  return amount_spent * .30 * 0.79 / 4 * 52;
}
...
function consumption_cellphone_conv() {
  ...
  //TODO: "same as SCU, may need fact checking" <- Someone wrote that before.
  ...
  // TODO: No source given for this one. Do we have it?
  ...
  // TODO: This calculation also doesn't have a source, but it came from SCU.
  ...
  *******************************************/
  ...
  function energy_audit_dorm_conv() //kwh to kg source: https://www.epa.gov/sites/production/files/2015-07/documents/emission-factors_2014.pdf
  {
    ...
    while (iteration < (total_appliance + 1)) { // TODO: How does this work? I'll make it more efficient. Continue here.
