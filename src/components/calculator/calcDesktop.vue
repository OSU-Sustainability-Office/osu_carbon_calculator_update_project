    ...
    <el-col id="rightBorder" :span="16" v-show="!lastSlide">
      <el-row class="centerContent">
        <el-col :span="2" centered>
          <el-button class="headerButton" v-on:click="prev()" type="primary" icon="el-icon-arrow-left" :disabled="currentTitle === 0"></el-button>
        </el-col>
        <el-col :span="20">
          <h1>{{determineTitle}}</h1>
        </el-col>
        <el-col :span="2">
          <el-button class="headerButton" v-on:click="next()" type="primary"><i class="el-icon-arrow-right"></i></el-button>
        </el-col>
      </el-row>
      <el-row>
