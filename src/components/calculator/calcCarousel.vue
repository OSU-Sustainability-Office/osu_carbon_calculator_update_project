  ...
  <el-carousel v-loading="loading" ref="carousel" trigger="click" height="76vh" :autoplay="false" arrow="never" :initial-index="1" indicator-position="none" @change="setFocus">
    ...
    <el-carousel-item name="About">
      <FocusLock :disabled="focus !== 1">
        ...
        <center>
          <el-radio v-model="studentType" label="On Campus Resident Student" border></el-radio>
          <el-radio v-model="studentType" label="Full Time Commuter Student, Staff, or Faculty" border></el-radio>
          <el-radio v-model="studentType" label="Part-time Commuter Student, Staff, or Faculty" border></el-radio>
